...
function M.parse(arg)
    ...
    cmd:text()
    cmd:option('-netType',  'hg_att2', 'Options: hg-stacked | hg-generic')
    cmd:option('-loadModel',      'none', 'Provide full path to a previously trained model')
    cmd:option('-optimState',      'none', 'Provide full path to a previously trained model') -- Wei 2016-10-28
    ...
    cmd:option('-trainIters',       6000, 'Number of train iterations per epoch')
